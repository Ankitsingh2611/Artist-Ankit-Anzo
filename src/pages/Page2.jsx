...
const Page2 = () => {
  ...
  return (
    <div id='section2' className='bg-white text-black text-center p-10'>
        <h3 className='text-gray-500 font-[anzo3]'>©  ankitsingh.26 2024 | designed and developed</h3>
        <div className='rotateText mt-24'>
            <h1 className='text-[41vw] text-black font-[anzo5] uppercase leading-[33vw]'>IMPACTFUL</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[41vw] text-black font-[anzo5] uppercase leading-[33vw]'>DESIGN</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[41vw] text-black font-[anzo5] uppercase leading-[33vw]'>IS THE</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[41vw] text-black font-[anzo5] uppercase leading-[33vw]'>DESIGN</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[41vw] text-black font-[anzo5] uppercase leading-[33vw]'>THAT</h1>
        </div>
        <div className='rotateText flex justify-center items-center'> 
            {/* <h1 className='text-[41vw] text-black font-[anzo5] uppercase leading-[33vw]'>WORKS!</h1>  */}
            <video loop muted autoPlay="true" className='h-[60%]  w-[70%] object-cover' src="./src/assets/motion.mp4"></video>
        </div>
    ...
    <g>
        ...
        <div className='h-0.5 w-1/3 relative left-1/2 -translate-x-1/2 mt-8 bg-black'></div>
